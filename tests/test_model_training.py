...
def test_train_model():
    ...
    # Vérifications
    assert isinstance(model, RandomForestClassifier), "Le modèle doit être une instance de RandomForestClassifier"
    assert hasattr(model, "predict"), "Le modèle entraîné doit avoir une méthode 'predict'"
